...
class jingzhun:
    ...
    def __init__(self):
        self.headers = {
            ...
            ,"Cookie": "_kr_p_se=f3ff90ed-273f-431b-8642-b18322e29762; krid_user_id=1500884664; krid_user_version=5; kr_plus_id=1500884664; kr_plus_token=rGId9RHtafPKpJpKBN98ozvWK2SPO46562_4____; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%221500884664%22%2C%22first_id%22%3A%221782f002ed1885-07ce8a1bd116ac-5771133-1327104-1782f002ed2639%22%2C%22props%22%3A%7B%22%24latest_traffic_source_type%22%3A%22%E7%9B%B4%E6%8E%A5%E6%B5%81%E9%87%8F%22%2C%22%24latest_search_keyword%22%3A%22%E6%9C%AA%E5%8F%96%E5%88%B0%E5%80%BC_%E7%9B%B4%E6%8E%A5%E6%89%93%E5%BC%80%22%2C%22%24latest_referrer%22%3A%22%22%7D%2C%22%24device_id%22%3A%221782f002ed1885-07ce8a1bd116ac-5771133-1327104-1782f002ed2639%22%7D; JSESSIONID=6C6F6145B544C24C73EE83ED2FF9069F; acw_tc=276082a916158695456745100e8c17ae866e8efa4495656908b0537afb4b7e"
        }
        ...
        data = [item["品牌名称"],item["英文名称"],item["机构官网"],item["成立时间"],item["主要投资领域"],
                ...
                item["被投公司简称"],item["社保缴纳人数"],item["市值"],item["交易轮次"],
                            item["来源"],item["交易时间"],
                             ...
                             item["战略新兴产业"],item["标签"],item["注册地址"],item["办公地址"],
    ...
    def parse_detail(self,value,dt):
        ...
        try:
            ...
            if len(response["result"]["data"]["tableData"]) > 0:
                ...
                if response["result"]["data"]["tableData"][0]["reg_location"] is not None:
                    dt["注册地址"] = response["result"]["data"]["tableData"][0]["reg_location"]
                else:
                    dt["注册地址"] = "无"
                if response["result"]["data"]["tableData"][0]["office_address"] is not None:
                    dt["办公地址"] = response["result"]["data"]["tableData"][0]["office_address"]
                else:
                    dt["办公地址"] = "无"
                if type(dt["市值"]) == dict:
                    dt["市值"] = "无"
